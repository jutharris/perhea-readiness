...
export const storageService = {
  ...
  saveEntry: async (entryData: any): Promise<WellnessEntry> => {
    checkConfig();
    ...
    return {
      ...
      plannedMissionType: data.planned_mission_type,
      wearableScore: data.wearable_score,
      divergenceIntensity: data.divergence_intensity,
      lastSessionRPE: data.last_session_rpe,
      energy: data.energy,
      ...
      stress: data.stress,
      social: data.social,
      feelingSick: data.feeling_sick,
      injured: data.injured,
      menstrualCycle: data.menstrual_cycle,
      comments: data.comments,
      readByCoach: !!data.read_by_coach
    };
  },
